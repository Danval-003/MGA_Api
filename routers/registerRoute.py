...
def obtainRegisterDate():
    ...
    query = """select cantidad_alimento, decesos, observaciones, fecha, ca, g.id_galera, id_registro, pesado, date_part('day', g.fecha_inicio) - date_part('day', now()), tipo_pollo from 
