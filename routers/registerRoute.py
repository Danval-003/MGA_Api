...
def obtainRegisterDate():
    ...
    query = """select cantidad_alimento, decesos, observaciones, fecha, ca, g.id_galera, id_registro, pesado,  date_part('day', now()) -  date_part('day', g.fecha_inicio), tipo_pollo from 
